                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input v-model="residentForm.full_name" type="text" class="form-control" :class="{ 'error-input': errors.full_name }" required />
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input v-model="residentForm.id_card_number" class="form-control" :class="{ 'error-input': errors.id_card_number }"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input v-model="residentForm.date_of_birth" type="date" class="form-control" :class="{ 'error-input': errors.date_of_birth }" required />
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input v-model="residentForm.phone_number" type="tel" class="form-control" :class="{ 'error-input': errors.phone_number }"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input v-model="residentForm.email" type="email" class="form-control" :class="{ 'error-input': errors.email }"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input v-model="residentForm.move_in_date" type="date" class="form-control" :class="{ 'error-input': errors.move_in_date }"
                                placeholder="Nhập email" required />
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input v-model="residentForm.registration_date" type="date" class="form-control" :class="{ 'error-input': errors.registration_date }" required />
                    ...
                    <div class="mb-3">
                        ...
                        <select v-model="residentForm.registration_status" class="form-select" :class="{ 'error-input': errors.registration_status }" required>
